...
// Enrolement API Controller, contains a series of functions used to manipulate
// data from the database approriatly using axios on different events in components
...
class EnrolmentController extends Controller
{
    ...
    {
        // retreive all enrolements with courses and students
    ...
    {
        //find enrolment by id and return enrolement object 
    ...
    public function update(Request $request, $id)
    {
        ...
        //array of messages displayed if student and course are already linked
        $messages = [
            'course_id.unique' => 'Student is already enrolled on course',
            'student_id.unique' => 'Student is already enrolled on course'
        ];
        ...
        // storing all input values from the form into variables that are object properties that
    ...
    // Passes in an id, if the id is round delete the enrolement, return success response if Successful
